...
const Footer2 = () => {
  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-100 mt-20 px-6 py-16">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12 items-center">
        <div>
          <h2 className="text-3xl font-bold text-gray-950 tracking-tight">Stay Connected</h2>
          <p className="text-gray-600 mt-2 max-w-sm">Receive the latest design insights and project updates directly in your inbox.</p>
        </div>
        ...
        <div className="md:col-span-2 flex flex-col sm:flex-row gap-3">
          <input 
            ...
            className="flex-grow px-5 py-3 rounded-full border border-gray-200 focus:ring-2 focus:ring-indigo-200 outline-none transition-all" 
          />
          <button className="bg-indigo-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-indigo-700 transition-all shadow-md active:scale-95 flex-shrink-0">
            Subscribe Now
          </button>
        </div>
      </div>
      
      <div className="max-w-7xl mx-auto mt-16 pt-10 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-8 text-gray-500">
        <div className="flex flex-col gap-1 items-center sm:items-start">
          <span className="text-2xl font-black text-indigo-700 tracking-tighter">NEXUS</span>
          <p className="text-xs">Building the future of UI components.</p>
        </div>
        ...
        <div className="flex gap-4">
          {socialLinks.map((social) => (
            <a 
              ...
              className={`w-10 h-10 rounded-full bg-white border border-gray-100 flex items-center justify-center text-gray-500 transition-all duration-300 shadow-sm ${social.hover}`}
            >
              <svg 
